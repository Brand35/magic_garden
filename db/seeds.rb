...
item = Item.new(name: "Scato-pelle", description: "pelle qui ramasse les crottes de chien dans ton jardin pour en faire de l’engrais.", available: "not available", price: 300, owner: User.find_by(email:"ophelie@magicgarden.com") )
...
item = Item.new(name: "Arrosound", description: "arrosoir qui fait de la musique pour faire pousser tes plantes.", available: "available", price: 300, owner: User.find_by(email:"ophelie@magicgarden.com") )
...
item = Item.new(name: "Mignarrosoir", description: "arrosoir trop mignon à arc-en-ciel.", available: "available", price: 300, owner: User.find_by(email:"ophelie@magicgarden.com") )
