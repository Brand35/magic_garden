...
puts "Created "
Item.create(name: "Hair-rosoir", description: "arrosoir qui fait pousser les cheveux lorsque tu arrose ta tête.", available: "available", price: 200, owner: User.find_by(email:"omar@magicgarden.com") )
puts "Created "
...
puts "Created "
Item.create(name: "Arrosound", description: "arrosoir qui fait de la musique pour faire pousser tes plantes", available: "available", price: 70, owner: User.find_by(email:"omar@magicgarden.com") )
puts "Created "
